...
FINAL_COMBO_ID = 0
FINAL_COMBO_NAME = "final_stable_sigma0p7_mass3"
...
def final_size_overrides() -> dict[str, Any]:
    ...
    n_eval = env_int("KEDRL_FINAL_BENCHMARK_POINTS", 50)
    return {
        ...
        "optimization": {
            ...
            "lr": env_float_text("KEDRL_FINAL_LR", "0.0001"),
            "weight_decay": env_float_text("KEDRL_FINAL_WEIGHT_DECAY", "1e-4"),
            "mass_anchor_lambda": float(os.environ.get("KEDRL_FINAL_MASS_ANCHOR", "3.0")),
            ...
            "eta_clip_max": float(os.environ.get("KEDRL_FINAL_ETA_CLIP_MAX", "3.0")),
        },
    }
